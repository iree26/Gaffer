    ...
    <div className="gaffer-app">
      ...
      <style>{`
        .gaffer-app{
          ...
          position:relative; min-height:100svh; width:100%; background:transparent; color:var(--ink);
        ...
        .panel{ width:100%; background:rgba(255,255,255,.74); backdrop-filter:blur(12px);
          border:1px solid var(--line); border-radius:24px; padding:clamp(1.5rem,5vw,2.4rem);
          box-shadow:0 20px 60px rgba(7,94,50,.1); }
        ...
        .opt{ text-align:left; cursor:pointer; border:1.5px solid var(--line); border-radius:13px; padding:1rem 1.1rem;
          ...
          opacity:0; transform:translateY(14px); animation:cardUp .45s forwards; }
        ...
        .score-num{ font-family:var(--display); font-weight:800; font-size:clamp(3.4rem,16vw,5.5rem); line-height:1; color:var(--deep); }
        ...
        .note{ color:var(--deep); opacity:.85; font-weight:500; max-width:34ch; margin:1rem auto 1.8rem; line-height:1.5; }
