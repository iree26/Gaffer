  ...
  return (
    <div className="gaffer-app">
      ...
      <style>{`
        ...
        .wrap{ max-width:720px; margin:0 auto; padding:clamp(1.4rem,5vw,2.5rem) clamp(1rem,5vw,2rem) 0; }
        ...
        .pod{ background:rgba(255,255,255,.8); backdrop-filter:blur(8px); border:1px solid var(--line); border-radius:18px;
        ...
        .section-label{ font-size:.72rem; font-weight:800; letter-spacing:.12em; text-transform:uppercase; color:var(--bright);
        ...
        .row{ display:grid; grid-template-columns:2.6rem 1fr auto 2.6rem 2.2rem; align-items:center; gap:.6rem;
          background:rgba(255,255,255,.72); backdrop-filter:blur(8px); border:1px solid var(--line); border-radius:13px;
        ...
        .row.you{ border-color:var(--bright); background:rgba(22,180,95,.08); }
        ...
        .stars .s.half{ background:linear-gradient(90deg,var(--bright) 50%,var(--line) 50%); -webkit-background-clip:text;
      ...
      <main className="wrap">
        ...
        <div className="podium">
          {/* order: 2nd, 1st, 3rd for the podium look */}
